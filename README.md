...
1. **Vulnerability Detection Configuration**:
   - I configured the **Vulnerability Detector** module in Wazuh, which integrates CVE databases and security advisories to automatically scan for vulnerabilities across the network.
...
1. **Creating Custom Reports**:
   - I configured Wazuh to generate regular reports summarizing detected vulnerabilities, the status of mitigation efforts, and any ongoing risks. These reports were designed to be easily understandable for stakeholders and IT personnel.
   
   *(![IMG_2224](https://github.com/user-attachments/assets/26dbeda0-c051-40d7-9812-b2accd7be574)
...
- Detect the vulnerability early using **Wazuh**'s vulnerability detection module.
- Implement effective mitigation strategies, including patching systems, disabling risky features in Microsoft Office, and educating users.
...
This project reinforced the importance of using a SIEM system like Wazuh for proactive vulnerability management. By configuring Wazuh to monitor for known vulnerabilities, detect exploits, and mitigate risks through patches and system configuration changes, I was able to ensure the environment remained secure and resilient to future threats.
